    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            ...
            <div class="butns">
                ...
                {{-- 
                    <a href="#" class="btn btn-warning ms-2" id="delete-selected-payments">Delete</a><form action="{{url('admin/previous-payments/export')}}" class="d-flex justify-content-end my-2 ms-2" method="POST" id="export-excel-form">
                    @csrf
        ...
        $(document).ready(function() {
            ...
            if (!$.fn.dataTable.isDataTable(table)) {
                ...
                var table = table.DataTable({
                    ...
                    scrollX: true,
                    ajax: {
                        url: "{{url('admin/previous-payments')}}",
                    },
                    columns: [{
                            name: 'sr_no',
                            data: 'sr_no'
